...
public class MovingViolationsManagerView {
	...
	public void printReq4C(MaxHeapCP<InfraccionesViolationCode> resultados) {
		...
		while(resultados.darNumElementos()>0) {
			InfraccionesViolationCode a = resultados.delMax();
			String x="";
			for (int j = 0; j < a.getTotalInfracciones(); j+=6) {
				x+="*";
			}
			System.out.println(a.getViolationCode() + "|"+ x);
		}	
		System.out.println("Cada * representa 6 infracciones");
	}
